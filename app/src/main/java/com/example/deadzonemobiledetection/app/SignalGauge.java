...
public class SignalGauge extends View {
    ...
    public SignalGauge(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        readAttrs(context, attrs, defStyle);
        init();
    }

    public SignalGauge(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SignalGauge(final Context context) {
        this(context, null, 0);
    }

    public interface signalGaugeObserver {
        void callback();
    }

    private signalGaugeObserver mObserver;

    public void setObserver(signalGaugeObserver observer) {
        mObserver = observer;
    }

    private void setNeedleTargetActivityClass() {
        if (mObserver != null) {
            mObserver.callback();
        }
    }
